...
<head>
    <meta charset="UTF-8">
    <title>Examinations Online E-Service | Examinations Council of Lesotho</title>
    ...
    <main>
        ...
        <section id="logo_container">
            ...
            <div class="info-online">
                ...
                <p>Examinations Online E-Service System</P>
            </div>
        </section>
        <!-- logo section -->
        <div class="container-flud" id="eservices">
            <form class="row" id="eserviceform" method="POST" action="{{ route('services.multiform') }}"
                    ...
                    <div class="d-flex align-items-start  sm:mb-5 progress-form__tabs" role="tablist">
                        <button id="progress-form__tab-1" class="flex-1 px-0 pt-2 progress-form__tabs-item"
                            ...
                            <div class="form-group">
                                ...
                                <input name="Ecom_BillTo_Postal_Name_First" readonly="readonly" type="hidden"
                                    value="John" id="Ecom_BillTo_Postal_Name_First" class="clsInputReadOnlyText" />
                                ...
                                <input type="hidden" readonly="readonly" class="clsInputReadOnlyText"
                                    name="Ecom_ShipTo_Postal_Street_Line1" id="Ecom_ShipTo_Postal_Street_Line1"
                                    value="50 Sunny Drive Avenue" />
                                <input type="hidden" readonly="readonly" class="clsInputReadOnlyText"
                                    name="Ecom_ShipTo_Postal_Street_Line2" id="Ecom_ShipTo_Postal_Street_Line2"
                                    value="Sunsetville" />
                                <input type="hidden" readonly="readonly" class="clsInputReadOnlyText"
                                    name="Ecom_ShipTo_Postal_City" id="Ecom_ShipTo_Postal_City" value="Johannesburg" />
                                <input type="hidden" readonly="readonly" class="clsInputReadOnlyText"
                                ...
                                <input type="hidden" readonly="readonly" name="Lite_Order_LineItems_Quantity_1"
                                ...
                                <input name="Merchant_ApplicationID" type="hidden"
                                    value="{0cbe5585-f899-482b-85e1-f1c7fff588fc}" maxlength="40"
                                    id="Merchant_ApplicationID" class="clsInputText" />
                                <input type="hidden" name="Lite_Merchant_ApplicationID"
                                    value="{0cbe5585-f899-482b-85e1-f1c7fff588fc}" id="Lite_Merchant_ApplicationID" />
                                ...
                                <input type="hidden" readonly="readonly" class="clsInputReadOnlyText"
                                    name="Ecom_ShipTo_Telecom_Phone_Number" id="Ecom_ShipTo_Telecom_Phone_Number" />
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade p-3" id="vcl-mpesa" role="tabpanel"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mpesa_mobile" class="form-control" id="mpesa_mobile"
                                ...
                                <div class="card  bg-white shadow p-5">
                                    <div class="mb-4 text-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="text-success" width="75"
                                            height="75" fill="currentColor" class="bi bi-check-circle"
                                            viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p>You will receive an order confirmation email with details of your order
                ...
                <div class="col-sm-12 col-md-5  col-lg-5" id="service-order">
            ...
            function addToCart(elem) {
                ...
                carttable = `<tr><th colspan='2'>Your Invoice</th></tr>
                       <tr><td>${services.serviceName}</td><td>M${services.price.toFixed(2)}</td></tr>
                        <tr><td>Total</td><td>M${services.price.toFixed(2)}</td></tr>`;
