    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="ruleForm" method="POST">
                ...
                <!-- Stock-Item Selection Panel -->
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Stock-Item Selection</h4>
                    </div>
                ...
                <!-- Base Calculation Panel -->
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Base Calculation</h4>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Extras (Optional)</h4>
                    </div>
                    <div class="panel-body">
