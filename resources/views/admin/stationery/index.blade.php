                        ...
                        <div class="panel-body">
                            ...
                            <div class="custom-tabs-line tabs-line-bottom left-aligned">
                                <ul class="nav" role="tablist">
                                    <li class="active"><a href="#stock-types-tab" role="tab" data-toggle="tab">Stock Types</a></li>
                                    <li><a href="#stock-items-tab" role="tab" data-toggle="tab">Stock Items</a></li>
                                    <li><a href="#component-stock-tab" role="tab" data-toggle="tab">Component Stock</a></li>
...
$(document).ready(function() {
    ...
    function initStockItemsTable() {
        ...
        $("#stockItemTable").css("width", "98.5%");

        $('#addStockItemBtn').off('click').on('click', function() {
        ...
        $(document).off('click', '#stockItemTable .edit-btn').on('click', '#stockItemTable .edit-btn', function(e) {
            loadStockTypes();
            e.preventDefault();
            let url = $(this).data('url');
        ...
        $(document).off('click', '#stockItemTable .view-btn').on('click', '#stockItemTable .view-btn', function(e) {
            e.preventDefault();
            let url = $(this).data('url');
        ...
        $('#stockItemForm').off('submit').on('submit', function(e) {
            e.preventDefault();
        ...
        $(document).off('click', '#stockItemTable .delete-btn').on('click', '#stockItemTable .delete-btn', function(e) {
            e.preventDefault();
    ...
    $('#ruleForm').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                componentStockTable.ajax.reload();
                toastr.success(response.message);
            },
            error: function(xhr) {
                if (xhr.status === 422) {
