    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">Workflow History</h3>
                <div class="row">
                    <div class="col-md-12">
                        <!-- PANEL NO CONTROLS -->
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-striped" id="workflow-steps-history-table">
                                    <thead>
                                        <tr>
                                            <th>Step</th>
                                            <th>Role</th>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                $('#workflow-steps-history-table').DataTable({
                    "paging": false,
                    "searching": false,
                    "ordering": false,
                    "info": false
                ...
                $("#workflow-steps-history-table").css("width", "98.5%");
            });
        </script>
    @endpush
@endsection