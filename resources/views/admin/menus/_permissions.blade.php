    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="permissionModalTitle">
                    Menu Permissions
                </h3>
                ...
                <div class="panel panel-default" style="width: 100%; margin: 0; padding: 0;">
                    ...
                    <div class="panel-body" style="padding: 0;">
                        <div class="table-responsive" style="width: 100%;">
                            <table class="table table-bordered table-hover table-striped mb-0" id="permissionsTable"
                                style="width: 100%;">
...
@push('styles')
 ...
 <style>
    /* Make validation error text red */
    .invalid-feedback {
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.permissions-btn', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        let permissionOptions =
                            '<option value="">Select Permission</option>'; // reset permissions dropdown
                        $.each(response.permissions, function(id, name) {
                            permissionOptions +=
                                `<option value="${id}">${name}</option>`; // build options
                        });
                ...
                `;
                            ...
                            drawCallback: updatePermissionCount
                        });
        ...
        $(document).on('click', '.delete-permission-btn', function(e) {
            ...
            $.ajax({
                url: '{{ route('admin.menu-permissions.destroy') }}',
                type: 'DELETE',
                data: {
                    menu_id: currentMenuId,
                ...
                error: function() {
                    toastr.error('Error removing permission');
                }
            });
        });
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            response.guards.forEach(function(guard) {
                                guardOptions +=
                                    `<option value="${guard}">${guard.charAt(0).toUpperCase() + guard.slice(1)}</option>`;
                            });
