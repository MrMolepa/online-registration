                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade in active" id="table-view">
                                                <button type="button" class="btn btn-primary pull-left" id="addMenuBtn"
    ...
    <script>
        $(document).ready(function () {
            ...
            function clearValidationErrors() {
                $('#menuForm .form-group').removeClass('has-error');
                $('#menuForm .help-block.text-danger').text('');
            }
                    ...
                    error: function (xhr) {
                        if (xhr.status === 422) {
                            ...
                            $.each(errors, function (field, messages) {
                                let input = $('#menuForm [name="' + field + '"]');
                                input.closest('.form-group').addClass('has-error');
                                input.closest('.form-group').find('.help-block.text-danger').text(messages[0]);
                            });
                        } else {
